                            ...
                            <div class="col-12">
                                <div class="row mb-3">
                                    <div class="col-md-9 col-lg-6 col-sm-6 col-6">
                                        <select class="form-select" id="ukuran" aria-label="Default select example" disabled>
                                            <?php
                                            $stokS = 0;
                                            foreach ($stok as $s) {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="https://api.whatsapp.com/send?phone=6285877132855&text=Halo%20Admin%20Saya%20Mau%20Order%20Produk%20Jilbab" class="btn btn-primary"><i class='bx bxl-whatsapp'></i>Beli Sekarang</a>
                                    </div>
                                </div>
                            </div>
                        </div>
